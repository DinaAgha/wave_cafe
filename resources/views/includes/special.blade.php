  ...
  <!-- <div class="tm-special-items"> -->
    ...
    <div class="tm-black-bg tm-special-item">
      ...
      <div class="tm-special-item-description">
        ...
        <p class="tm-special-item-text">Pellentesque in ultrices mi, quis mollis nulla. Quisque sed commodo est, quis
          tincidunt nunc.</p>
      </div>
    </div>
    <div class="tm-black-bg tm-special-item">
      ...
      <div class="tm-special-item-description">
        ...
        <p class="tm-special-item-text">Vivamus finibus nulla sed metus sagittis, sed ultrices magna aliquam. Mauris
          fermentum.</p>
      </div>
    </div>
    <div class="tm-black-bg tm-special-item">
