          ...
          <section class="login_content">
            <form method="POST" action="{{ route('login') }}">
              ...
              <div>
                ...
                <input id="username" type="text" class="form-control @error('username') is-invalid @enderror" name="username" value="{{ old('username') }}" placeholder="Admin User Name" required autocomplete="name" autofocus>
                @error('username')
