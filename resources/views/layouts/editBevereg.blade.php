					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								<div class="x_title">
									<h2>Edit Beverage</h2>
                                    <form action="{{ route('updateBevereg', $client->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
									...
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="bname" name="bname" required="required" class="form-control ">
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<textarea id="descrip" name="descrip" required="required" class="form-control">Contents</textarea>
											</div>
										</div>
										<div class="item form-group">
